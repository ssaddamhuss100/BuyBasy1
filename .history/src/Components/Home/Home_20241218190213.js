        ...
        <>
            <div className={styles.container}>
                <aside className={styles.filterContainer}>
                    <h2>Filter</h2>
                    <form>
                        <label htmlFor="price" className={styles.price}>Price: {priceFilter}</label>
                        <input type="range" name="price" min="1" max="1000" step="20" value={priceFilter} className={styles.price} 
                        onChange={handlePriceFilter} />
                        <h2>Category</h2>
                        <div className={styles.catgoryContainer}>
